 ...
 *
 * @author Richard Persche
 * @since patch 5.1.1 version to also return attributes
 */
public class Cas20ResponseView extends AbstractDelegatingCasView {
    ...
    public Cas20ResponseView(final boolean successResponse,
                             ...
                             final View view,
                             final boolean releaseProtocolAttributes) {//ECLKC
        super(successResponse, protocolAttributeEncoder, servicesManager, authenticationContextAttribute, view);
        this.releaseProtocolAttributes = releaseProtocolAttributes;  //ECLKC
    }
    ...
    protected void prepareMergedOutputModel(final Map<String, Object> model, final HttpServletRequest request,
        ...
        LOGGER.debug("ECLKC Add attributes [{}]", model.keySet());
        ...
        LOGGER.debug("ECLKC Processed response principal attributes from the output model to be [{}]", principalAttributes.keySet());
