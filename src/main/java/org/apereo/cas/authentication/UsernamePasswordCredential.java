 ...
 * @since 3.0.0
 * Modified for ECLKC to all 2FA token to be submitted too.
 *
...
public class UsernamePasswordCredential implements Credential, Serializable {
    ...
    /**
     * ECLKC Creates a new instance with the given username and password and token.
     *
     * @param userName Non-null user name.
     * @param password Non-null password.
     * @param token Non-null token.
     */
    public UsernamePasswordCredential(final String userName, final String password, final String token) {
        this.username = userName;
        this.password = password;
        this.token = token;
    }
